...
**AEM Project Archetype** - Maven 템플릿을 사용하여 최소 AEM 프로젝트를 생성하여 AEM 개발에 대한 기존 접근 방식 대량 맞춤화를 예상하는 AEM 6.5/6.4 프로젝트 및 AEM as a Cloud Service 프로젝트에 권장되는 접근 방식입니다. 이 튜토리얼에서는 AEM 개발에 대해 자세히 살펴볼 수 있습니다.
...
이 자습서를 실제 시나리오와 더 가깝게 만들기 위해 Adobe의 재능 있는 UX 디자이너가 [Adobe XD](https://www.adobe.com/products/xd.html)을 사용하여 사이트에 대한 mockup을 만들었습니다. 튜토리얼의 과정에서 다양한 디자인 조각이 완전히 작성 가능한 AEM 사이트로 구현됩니다. WKND 사이트를 위한 멋진 디자인을 만들어 주신 **Lorenzo Buosi** 및 **Kilian Amendola**&#x200B;에게 특별한 감사를 드립니다.
...
이 자습서에서는 AEM 개발자에게 필요한 주요 개발 기술을 다루지만 전체 사이트를 완전히 빌드하는 것은 *아니요*&#x200B;입니다. 완성된 참조 사이트는 AEM의 기본 기능을 더 많이 탐색하고 볼 수 있는 또 다른 훌륭한 리소스입니다.
...
무엇을 기다리고 있습니까?! [AEM Project Archetype을 사용하여 새 Adobe Experience Manager 프로젝트를 생성](./project-archetype/overview.md)하거나 [사이트 템플릿을 사용하여 사이트를 생성](./site-template/create-site.md)하는 방법에 대해 알아봅니다.
