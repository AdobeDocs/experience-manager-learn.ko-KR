...
description: Adobe Experience Manager을 Cloud Service과 Adobe Target으로 사용하여 개인화된 경험을 제작 및 전달하는 방법을 살펴볼 수 있습니다.
...
Adobe Experience Manager(AEM)과 Adobe Target은 경쟁 제품으로 잘못 해석될 수 있는 무료 기능을 갖춘 강력한 솔루션입니다. 고객은 이러한 제품을 어떻게 언제 어떻게 사용하는지 파악하여 개인화된 경험을 전달할 수 있습니다. 모든 최종 사용자에게 최적화된 경험을 전달하려면 조직 내의 다양한 팀이 긴밀하게 작업하고 누가 어떤 작업을 수행하는지 정의해야 합니다.
