...
+ 문서 작성 {#document-authoring}
   ...
   + [미리 보기 및 게시](document-authoring/preview-and-publish.md)
   + [문서 구조](document-authoring/document-structure.md)
   + [기본 콘텐츠 및 섹션](document-authoring/default-content-and-sections.md)
   + [블록 및 자동 블록](document-authoring/blocks-and-autoblocks.md)
   + [리디렉션](document-authoring/redirects.md)
   + [대량 메타데이터](document-authoring/bulk-metadata.md)
   ...
   + 방법{#how-to}
      ...
      + [iFrame 임베드](./document-authoring/how-to/iframes.md)
      + [이미지 대체 텍스트](./document-authoring/how-to/image-alt-text.md)
      + [검색 엔진 인덱싱 방지](./document-authoring/how-to/no-index.md)
      + [반응형 탐색](document-authoring/how-to/responsive-navigation.md)
      + [Dynamic Media](./document-authoring/how-to/using-dynamic-media.md)
      + [가져오기 도구를 사용한 사이트 마이그레이션](./document-authoring/how-to/migration-using-importer.md)
      + [가져오기 도구 맞춤화](./document-authoring/how-to/customizing-importer.md)
      + [가져오기 도구를 사용한 일괄 가져오기](./document-authoring/how-to/bulk-importing-using-importer.md)
      + 변형 생성{#generate-variations}
         ...
         + [Adobe Target 대상자](./document-authoring/how-to/generate-variations/using-target-audiences.md)
         ...
         + [보안 및 개인정보 보호](./document-authoring/how-to/generate-variations/trust-privacy.md)
      ...
      + [실험용 메타데이터](./document-authoring/how-to/experimentation-add-metadata.md)
...
+ 콘텐츠 조각 {#content-fragments}
   ...
   + [콘텐츠 조각과 경험 조각 비교](content-fragments/understand-content-fragments-and-experience-fragments.md)
...
+ Edge Delivery Services{#edge-delivery-services}
   ...
   + 개발{#developing}
      ...
      + [AEM 보일러플레이트](edge-delivery-services/developing/aem-boilerplate.md)
      + [콘텐츠 저장소](edge-delivery-services/developing/content-repository.md)
      + [미리 보기 및 게시](edge-delivery-services/developing/preview-and-publish.md)
      ...
      + 범용 편집기 {#universal-editor}
         ...
         + [CSS로만 구성된 블록](./edge-delivery-services/developing/universal-editor/7a-block-css.md)
         + [CSS 및 JS로만 구성된 블록](./edge-delivery-services/developing/universal-editor/7b-block-js-css.md)
         + 방법{#how-to}
            ...
            + [로컬 확장 기능 미리보기](./edge-delivery-services/developing/universal-editor/how-to/local-extension-preview.md)
   + 방법{#how-to}
...
+ 개발 {#developing}
   ...
   + [AEM 스타일 시스템으로 콘텐츠 속도 가속화](developing/accelerate-content-velocity-aem-style-system.md)
   + [페이지 차이용 개발](developing/page-diff-technical-video-develop.md)
   + [간단한 검색 구현](developing/search-tutorial-develop.md)
   + [소셜 미디어 공유](developing/social-media-sharing-technical-video-use.md)
   + [구성 요소 아이콘 맞춤화](developing/component-icons-technical-video-develop.md)
+ 개인화 {#personalization}
   ...
   + [Adobe Target을 통해 경험 조각 사용](personalization/experience-fragment-target-offer-feature-video-use.md)
...
+ 구성 요소 {#components}
   ...
   + [웹에 최적화된 이미지 게재](components/web-optimized-image-delivery.md)
...
+ 다중 사이트 관리 {#multi-site-management}
   ...
   + [언어 사본으로 국가 사이트 만들기](./multi-site-management/create-new-site.md)
+ 번역 {#translation}
...
+ 통합 {#integrations}
   ...
   + Adobe Experience Platform의 태그 {#experience-platform-data-collection-tags}
      ...
      + [IMS를 사용하여 AEM과 태그 속성 연결](integrations/experience-platform/data-collection/tags/connect-aem-tag-property-using-ims.md)
      + [AEM 태그 클라우드 서비스 만들기](integrations/experience-platform/data-collection/tags/create-aem-launch-cloud-service.md)
   ...
   + 분석 {#analytics}
      + [Adobe Analytics로 페이지 데이터 수집](integrations/analytics/collect-data-analytics.md)
   ...
   + Adobe Target {#target}
      ...
      + [태그 속성에 Target 확장 기능 추가](integrations/adobe-target/add-target-launch-extension.md)
      ...
      + [시각적 경험 작성기를 사용한 개인화](integrations/adobe-target/personalization-using-vec.md)
