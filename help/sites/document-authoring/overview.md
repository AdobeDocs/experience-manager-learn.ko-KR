---
title: 문서 작성 비디오
description: AEM에서 문서 작성을 설정하고 구성하는 방법을 알아봅니다.
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">문서 작성 설정 방법을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="preview-and-publish.md" title="콘텐츠 미리 보기 및 게시">편집기 개요</a>
            </p>
            <p class="is-size-6">AEM Sidekick을 사용하여 콘텐츠를 미리 보고 게시하는 방법에 대한 간략한 개요입니다.</p>
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">1분</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="default-content-and-sections.md" title="기본 콘텐츠 및 섹션">새로운 편집기 토글</a>
            </p>
            <p class="is-size-6">문서 작성 시 기본 콘텐츠와 섹션의 개념을 살펴봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">문서 작성 시 블록과 자동 블록의 개념을 살펴봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">문서 작성을 사용하여 리디렉션이 어떻게 생성되는지 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">문서 작성 시 대량 메타데이터가 처리되는 방식을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">문서 작성에서 페이지 메타데이터를 관리하는 방법을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">작성자 인증 구성 방법을 알아봅니다.</p>
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">2분</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./how-to/responsive-navigation.md" title="반응형 탐색">반응형 탐색</a>
            </p>
            <p class="is-size-6">문서 작성이 반응형 탐색을 어떻게 정의할 수 있는지 살펴봅니다.</p>
            <a href="page-metadata.md" class="spectrum-Button
              spectrum-Button--outline spectrum-Button--primary
              spectrum-Button--sizeM">
              <span class="spectrum-Button-label has-no-wrap
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">문서 작성에서 문서 감사를 처리하는 방식을 알아봅니다.</p>
            <a href="page-metadata.md" class="spectrum-Button
              spectrum-Button--outline spectrum-Button--primary
              spectrum-Button--sizeM">
              <span class="spectrum-Button-label has-no-wrap
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">문서 작성에서 문서 권한을 처리하는 방식을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">문서 작성에서 문서 버전을 처리하는 방식을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">문서 작성에서 문서 워크플로를 처리하는 방식을 알아봅니다.</p>
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">2분</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./how-to/iframes.md" title="iFrames 사용">iFrames 사용</a>
            </p>
            <p class="is-size-6">문서 작성에서 비디오와 iFrame을 처리하는 방법을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">문서 작성에서 이미지 대체 텍스트를 처리하는 방법을 알아봅니다.</p>
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">2분</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./how-to/no-index.md" title="인덱싱 방지">검색 엔진 인덱싱 방지</a>
            </p>
            <p class="is-size-6">검색 엔진의 인덱싱을 방지하는 방법을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">최적화된 이미지 게재를 위해 Dynamic Media를 사용하는 방법을 알아봅니다.</p>
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">2분</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./how-to/migration-using-importer.md" title="가져오기 도구를 사용한 사이트 마이그레이션">가져오기 도구를 사용한 사이트 마이그레이션</a>
            </p>
            <p class="is-size-6">AEM 가져오기 도구를 사용하여 사이트를 Edge Delivery Services로 마이그레이션하는 방법을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./how-to/customizing-importer.md" title="가져오기 도구 맞춤화">가져오기 도구 맞춤화</a>
            </p>
            <p class="is-size-6">사이트 마이그레이션을 위해 AEM 가져오기 도구를 맞춤화하는 방법을 알아봅니다.</p>
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">3분</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./how-to/bulk-importing-using-importer.md" title="가져오기 도구를 사용한 일괄 가져오기">가져오기 도구를 사용한 일괄 가져오기</a>
            </p>
            <p class="is-size-6">사이트 마이그레이션 중에 AEM 가져오기 도구를 사용하여 웹 페이지 일괄 가져오기를 수행하는 방법을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">Edge Delivery Services의 변형 생성에 대한 소개를 살펴보고 이것이 마케팅 담당자에게 어떻게 유용할 수 있는지 이해합니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">Edge Delivery Services 문서 작성의 변형 생성을 위해 Sidekick을 구성하는 방법을 살펴봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">변형 생성을 위한 프롬프트 템플릿을 사용하는 방법을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">변형 생성을 위한 사용자 정의 프롬프트 템플릿을 만드는 방법을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">변형 생성을 위한 사용자 정의 프롬프트 템플릿을 저장하는 방법을 알아봅니다.</p>
            <a href="./how-to/generate-variations/custom-prompt-templates.md" class="spectrum-Button
              spectrum-Button--outline spectrum-Button--primary
              spectrum-Button--sizeM">
              <span class="spectrum-Button-label has-no-wrap
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">2분</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./how-to/generate-variations/using-target-audiences.md" title="변형 생성 - Adobe Target 대상자 사용">변형 생성 - Adobe Target 대상자 사용</a>
            </p>
            <p class="is-size-6">Adobe Target 대상자를 사용하여 콘텐츠 변형에 적합한 대상자를 타기팅하는 방법을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">대상자 CSV 파일을 사용하여 콘텐츠 변형에 적합한 대상자를 타기팅하는 방법을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">Adobe Firefly를 사용하여 콘텐츠 변형에 사용되는 이미지를 만드는 방법을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">생성된 콘텐츠 변형에 사용할 수 있는 작업을 살펴봅니다.</p>
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">2분</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./how-to/generate-variations/trust-privacy.md" title="변형 생성 - 보안 및 개인정보 보호">변형 생성 - 보안 및 개인정보 보호</a>
            </p>
            <p class="is-size-6">Adobe에서 변형 생성에 대한 보안 및 개인정보 보호를 처리하는 방식을 알아봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">마케터가 어떤 콘텐츠 변형이 가장 효과적인지 테스트할 수 있는 실험 프레임워크를 살펴봅니다.</p>
      ...
      <div class="card">
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            ...
            <p class="is-size-6">Edge Delivery Services 문서 작성 시 실험 프레임워크를 설정하는 방법을 살펴봅니다.</p>
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">2분</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="./how-to/experimentation-add-metadata.md" title="실험용 메타데이터 추가">실험용 메타데이터 추가</a>
            </p>
            <p class="is-size-6">실험용 메타데이터 추가 살펴보기</p>
