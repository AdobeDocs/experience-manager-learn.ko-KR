...
<div class="columns is-multiline">
        ...
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="default-content-and-sections.md" title="기본 컨텐츠 및 섹션"
              tabindex="-1">
              <img class="is-bordered-r-small"
                src="https://video.tv.adobe.com/v/3425702/?format=jpeg" alt="기본 컨텐츠 및 섹션">
            </a>
          </figure>
        </div>
        <div class="card-content is-padded-small">
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen"
      ...
      <div class="card">
        <div class="card-image">
          <figure class="image is-16by9">
            <a href="bulk-metadata.md" title="벌크 메타데이터"
              tabindex="-1">
              <img class="is-bordered-r-small"
        ...
        <div class="card-content is-padded-small">
          <div class="content">
            <p style="float: right;font-style: italic; color: #363636"
              class="is-size-6">1분</p>
            <p class="headline is-size-6 has-text-weight-bold">
              <a href="bulk-metadata.md" title="벌크 메타데이터">언어 복사</a>
            </p>
