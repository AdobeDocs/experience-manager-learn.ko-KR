...
감시 폴더를 만드는 방법에 대해 자세히 알아보려면 [여기를 클릭하세요](https://helpx.adobe.com/kr/experience-manager/6-4/forms/using/Creating-Configure-watched-folder.html)
...
출력 서비스에 대해 자세히 알아보려면 [여기를 클릭하세요](https://helpx.adobe.com/kr/aem-forms/6/output-service.html).
