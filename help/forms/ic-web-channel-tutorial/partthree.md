...
이 부분에서 양식 데이터 모델을 만듭니다. 양식 데이터 모델을 사용하면 서로 다른 데이터 소스를 구성하고 연결할 수 있습니다. 연결된 데이터 소스에서 비즈니스 엔티티 및 서비스의 통합 데이터 표현 스키마를 만드는 직관적인 유저 인터페이스 다음 비디오에서는 양식 데이터 모델을 만드는 단계를 안내합니다.

**AEM Forms 6.4에서 양식 데이터 모델 생성**
...
Data Sources 구성에 대한 자세한 내용은 이 [link&#39;](parttwo.md)를 따르십시오.
