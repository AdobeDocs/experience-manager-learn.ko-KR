...
AEM/AEM Forms을 타사 애플리케이션과 통합하려면 클라우드 서비스 구성에서 Swagger 파일을 사용하여 [REST 기반 데이터 소스를](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/ic-web-channel-tutorial/parttwo.html?lang=ko)해야 합니다. 완성된 데이터 소스는 이 교육 과정 에셋의 일부로 제공됩니다.
