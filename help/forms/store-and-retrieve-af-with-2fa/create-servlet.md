---
title: 서블릿 만들기
description: 양식 데이터를 저장하기 위해 POST 요청을 처리하는 서블릿 만들기
...
다음 단계는 사용자 지정 OSGi 서비스의 적절한 방법을 호출하는 서블릿을 만드는 것입니다. 서블릿은 응용 양식 데이터, 파일 첨부 정보에 액세스할 수 있습니다. 서블릿은 부분적으로 완료된 응용 양식을 검색하는 데 사용할 수 있는 고유한 응용 프로그램 ID를 반환합니다.

이 서블릿은 사용자가 응용 양식의 저장 및 종료 단추를 클릭하면 호출됩니다.
