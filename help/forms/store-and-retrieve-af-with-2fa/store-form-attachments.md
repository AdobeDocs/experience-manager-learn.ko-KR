...
적응형 양식에 첨부 파일을 추가하면 해당 첨부 파일은 CRX 저장소의 임시 위치에 저장됩니다. 사용 사례가 제대로 작동하려면 양식 첨부 파일을 CRX 저장소의 새 위치에 저장해야 합니다.

OSGi 서비스는 양식 첨부 파일을 CRX 저장소의 새 위치에 저장하도록 만들어집니다. CRX에 있는 첨부 파일의 새 위치를 사용하여 새 파일 맵이 생성되고 호출 응용 프로그램으로 반환됩니다.
...
다음은 요청에서 첨부 파일을 추출하여 아래에 저장하는 코드입니다. **/content/afattachments** 폴더
