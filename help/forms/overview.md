---
title: AEM Forms 튜토리얼 및 비디오
description: AEM Forms 관련 비디오와 튜토리얼을 살펴보고, 궁금한 점을 해결할 수 있는 리소스와 설명서를 확인하십시오.
topic: Development
role: Developer
...
# AEM Forms 튜토리얼 및 비디오 {#overview}

Adobe Experience Manager(AEM)는 복잡한 디지털 양식을 만들고, 관리하고, 게시하고, 업데이트함과 동시에 백엔드 프로세스, 비즈니스 규칙 및 데이터와 통합할 수 있는 사용하기 쉬운 솔루션을 제공합니다. 이 사용 안내서에는 AEM Forms의 다양한 기능과 성능에 대한 비디오 및 튜토리얼이 포함되어 있습니다.
...
<tr>
  <td>
    ...
    <p>
    <em>적응형 양식은 역동적이고 반응성이 뛰어난 차세대 양식입니다. 적응형 양식을 사용하면 개인화된 경험을 제공할 수 있습니다.</em>
    <p>
  </td>
   <td>
    ...
    <p>
    <em>대화형 통신은 비즈니스 서신, 문서, 명세서, 혜택 공지, 마케팅 이메일, 청구서 및 환영 키트와 같은 안전하고 개인화된 인터랙티브한 통신의 작성, 수집 및 게재를 중앙 집중화하여 관리합니다. </em>
    <p>
  </td>
  <td>
    ...
    <p>
    <em>AEM Workflow의 한 단계로 양식 데이터 모델의 서비스를 호출합니다.</em>
    <p>
  </td>
</tr>
</table>
