...
+ 구성{#configuring}
   ...
   + [자동 시작 워크플로](configuring/auto-start-workflows.md)

+ 작성{#authoring}
   + [보기 전환](./authoring/switch-views.md)
...
+ 공동 작업{#collaboration}
   ...
   + [체크인 체크아웃](./collaboration/check-in-and-check-out.md)
   + [버전](./collaboration/versions.md)
   + [검토 작업](./collaboration/review-task.md)
...
+ 검색 및 발견{#search-and-discovery}
   ...
   + [유사 이미지 찾기](./search-and-discovery/find-similar-images.md)
...
+ 고급 기능{#advanced}
   ...
   + [프로그래밍 방식 에셋 업로드](./advanced/programmatic-asset-upload.md)
...
+ 크리에이티브 워크플로{#creative-workflows}
...
+ Adobe Asset Link{#adobe-asset-link}
   ...
   + [Adobe Asset Link 정보](./adobe-asset-link/launch-adobe-asset-link.md)
...
+ 콘텐츠 자동화{#content-automation}
   ...
   + [Photoshop 액션](./content-automation/photoshop-actions.md)
...
+ Dynamic Media{#dynamic-media}
   ...
   + 이미지 {#images}
      + [URL 구문 및 이미지 사전 설정](dynamic-media/dynamic-media-urls-and-image-presets.md)
      + [이미지 자동화](dynamic-media/dynamic-media-image-automation.md)
   ...
   + Viewers {#viewers}
      ...
      + [Adobe Analytics를 사용한 Viewers](dynamic-media/dynamic-media-viewer-extension-use.md)
   + 3D {#3d}
      + [Dynamic Media 3D](dynamic-media/dynamic-media-3d-feature-video.md)
   + AEM Sites와 함께 사용 {#dm-with-aem-sites}
   ...
   + 튜토리얼 {#tutorials}
      + [슬라이드 세트 만들기](dynamic-media/tutorials/creating-different-kinds-of-sets-with-aem-dynamic-media-carousel-sets.md)
      ...
      + [보안 미리보기 서버 구성](dynamic-media/tutorials/adding-test-image-server-details-in-dynamic-media-for-secure-preview.md)
      + [URL 및 임베드 코드 생성](dynamic-media/tutorials/how-to-generate-public-url-or-embed-code-for-an-asset.md)
...
+ Workfront 통합{#workfront}
   + 강화 커넥터{#enhanced-connector}
      + [강화 커넥터 기본 사항](./workfront/enhanced-connector/basics.md)
...
+ 번역 {#translation}
   + [소스 파일 번역](translation/source-file-translation-feature-video-use.md)
