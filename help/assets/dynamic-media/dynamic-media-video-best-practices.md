---
title: Dynamic Media 비디오 및 뷰어 모범 사례
description: 적응형 스트리밍, 다양한 화면 크기에 대한 스마트 자르기, 사용자 지정 뷰어 사전 설정, 캡션, 오디오 트랙 및 챕터 마커 지원을 포함하여 AEM Dynamic Media에서 비디오를 게시하고 최적화하는 모범 사례에 대해 알아봅니다.
