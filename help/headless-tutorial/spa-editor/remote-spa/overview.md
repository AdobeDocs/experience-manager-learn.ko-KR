...
>[!VIDEO](https://video.tv.adobe.com/v/3444854?captions=kor&quality=12&learn=on)
...
>[!NOTE]
>
> **로컬 개발 환경을 설정하는 데 도움이 필요하십니까?** AEM as a Cloud Service SDK을 사용하여 로컬 개발 환경을 설정하는 [다음 안내서를 확인하십시오](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/local-development-environment-set-up/overview.html?lang=ko).
