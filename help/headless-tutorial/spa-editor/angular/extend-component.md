...
이 장에서는 새 `Card` 구성 요소를 만듭니다. `Card` 구성 요소는 [이미지 핵심 구성 요소](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/components/image.html)를 확장하여 제목 및 콜 투 액션 버튼과 같은 추가 콘텐츠 필드를 추가하여 SPA 내의 다른 콘텐츠에 대한 티저 역할을 수행합니다.
