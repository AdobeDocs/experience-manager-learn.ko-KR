...
AEM Headless 모바일 배포는 iOS, Android™ 등을 위한 기본 모바일 앱입니다. headless 방식으로 AEM의 콘텐츠를 소비하고 상호 작용하는 것입니다.
...
| 모바일 앱이 DTM에 → | AEM Author | AEM 게시 인스턴스 | AEM 미리보기 |
|---------------------------------------------------:|:----------:|:-----------:|:-----------:|
       ...
       <div class="card">
           ...
           <div class="card-content is-padded-small">
               <div class="content">
                   ...
                   <p class="is-size-6">AEM Headless Android API의 콘텐츠를 사용하는 Java™ GraphQL™ 앱의 예입니다.</p>
