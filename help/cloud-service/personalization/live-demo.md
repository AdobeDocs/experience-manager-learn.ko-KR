...
| 페이지 | 보게 될 사항 | 테스트 방법 | 프로필 컨텍스트 | 경험 |
|------|-----------------|-------------|-----------------|------------|
| [홈](https://wknd.enablementadobe.com/us/en.html){target="wknd"} | 스키숍 인테리어는 다가오는 스키 모험을 준비하기 위한 전문가 포장 팁을 제공하는 &quot;추가 25% 할인&quot;**프로모션과 함께**&#x200B;프리미엄 스키 장비를 선보이고 있습니다 | `rwilson/rwilson`(으)로 로그인 및 페이지 새로 고침 | 최근에 구입한 스키 모험, 따라서 업셀링 스키 장비 | ![홈 - 스키 장비 업셀](./assets/live-demo/known-user-ski-gear-hero.png){width="200" zoomable="yes"} |
