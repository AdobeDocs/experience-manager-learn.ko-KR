...
1. **Splunk**: [Splunk 대시보드 도구](https://github.com/adobe/AEMCS-CDN-Log-Analysis-Tooling/blob/main/Splunk/README.md)를 사용하려면 Splunk에 액세스해야 하며 CDN 로그를 수집하려면 [AEMCS 로그 전달이 활성화되어야 합니다](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/developing/logging#splunk-logs).
