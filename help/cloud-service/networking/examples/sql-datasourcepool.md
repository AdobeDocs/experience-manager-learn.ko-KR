...
+ `AEM_PROXY_HOST`OSGi 구성 환경 변수[&#x200B; &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/deploying/configuring-osgi.html?lang=ko#environment-specific-configuration-values)을(를) 통해 연결의 호스트로 `$[env:AEM_PROXY_HOST;default=proxy.tunnel]` 값
