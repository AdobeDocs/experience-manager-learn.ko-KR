---
title: 전용 송신 IP 주소 및 VPN에 대한 비표준 포트에서 HTTP/HTTPS 연결
description: 전용 송신 IP 주소 및 VPN에 대한 비표준 포트에서 실행되는 AEM as a Cloud Service에서 외부 웹 서비스로 HTTP/HTTPS 요청을 수행하는 방법을 알아봅니다.
...
# 전용 송신 IP 주소 및 VPN에 대한 비표준 포트에서 HTTP/HTTPS 연결
