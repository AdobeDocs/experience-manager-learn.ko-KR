...
전자 메일 공급자(예: [&#x200B; 등)에 필요한 대로 AEM의 &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/development-guidelines.html?lang=ko#sending-email)DefaultMailService`smtp.ssl`을 구성하십시오.
