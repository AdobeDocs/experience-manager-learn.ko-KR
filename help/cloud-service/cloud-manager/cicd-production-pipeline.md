...
description: CI/CD 프로덕션 파이프라인은 스테이지를 통해 프로덕션 환경에 코드를 빌드 및 배포하는 데 사용되며, 가치 창출 시간을 단축합니다. CI/CD 프로덕션 파이프라인 구성은 파이프라인을 시작하는 트리거, 프로덕션 배포를 제어하는 매개변수 및 성능 테스트 매개변수를 정의합니다.
