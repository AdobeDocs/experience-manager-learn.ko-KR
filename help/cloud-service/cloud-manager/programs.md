---
title: Cloud Manager Adobe 사용 - 프로그램
...
# Cloud Manager Adobe 사용 - 프로그램

Cloud Manager **프로그램**&#x200B;은(는) 논리적 비즈니스 이니셔티브를 지원하는 AEM 환경 집합을 나타내며, 일반적으로 구매한 SLA(Service Level Agreement)에 해당합니다. 예를 들어 한 프로그램은 글로벌 공개 웹 사이트를 지원하는 AEM 리소스를 나타내고 다른 프로그램은 내부 중앙 DAM을 나타낼 수 있습니다.
