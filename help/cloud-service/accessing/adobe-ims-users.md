...
AEM 작성자 서비스에 액세스해야 하는 사용자는 [Adobe Admin Console](https://adminconsole.adobe.com)에서 [Adobe IMS 사용자](https://helpx.adobe.com/kr/enterprise/using/set-up-identity.html)(으)로 관리됩니다. Adobe IMS 사용자의 유형, Admin Console에서 액세스 및 관리되는 방법에 대해 알아봅니다.
