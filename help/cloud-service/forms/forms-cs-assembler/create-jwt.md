...
이전 단계에서 다운로드한 서비스 자격 증명에는 PKCS#1 형식의 개인 키가 포함되어 있습니다.이 문자열에서 개인 키를 추출하려면 [BouncyCastle](https://www.bouncycastle.org/) 라이브러리를 사용했습니다. Java의 일부인 암호화 라이브러리는 PKCS#1 형식을 지원하지 않습니다.
