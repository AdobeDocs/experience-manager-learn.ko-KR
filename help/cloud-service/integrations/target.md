...
1. 다음으로 이동 __에셋 > 파일__, &quot;Adobe Target enabled&quot; 폴더 아래에서 Target에 JSON으로 내보낼 콘텐츠 조각을 찾습니다
...
1. AEM에서 내보낸 콘텐츠 조각이 목록에 표시되는지 확인
   ...
   + 리뷰 __오퍼 정보__ 및 보기 __AEM 딥링크__ AEM Author 서비스에서 바로 콘텐츠 조각을 엽니다.
...
## Target 조각 오퍼를 사용한 오퍼 활동{#activity}
...
1. 선택 __+ 활동 만들기__&#x200B;을 클릭하고 생성할 활동 유형을 선택합니다.
...
1. 콘텐츠 텍스트 영역에서 콘텐츠 조각 오퍼 JSON을 검토합니다. 이는 콘텐츠 조각의 미리보기 작업을 통해 AEM 작성자 서비스에서 사용할 수 있는 JSON과 동일합니다.
