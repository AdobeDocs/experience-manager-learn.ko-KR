...
### asset compute 프로젝트에 Console.json 파일이 없습니다{#missing-console-json}

+ __오류:__ 오류: 유효성 검사(...)에 필요한 파일이 없습니다./node_modules/@adobe/asset-compute-client/lib/integrationConfiguration.:XX:jsYY(비동기 setupAssetCompute(...)/node_modules/@adobe/asset-compute-devtool/src/assetComputeDevTool.:XX:jsYY)
...
### manifest.html에서 잘못된 YAML 들여쓰기{#incorrect-yaml-indentation}
...
### 디버거가 첨부되지 않음{#debugger-does-not-attach}
...
### 중단점 일시 중지 안 함{#breakpoints-no-pausing}
...
### AEM의 자산에서 사용자 지정 표현물이 누락됨{#custom-rendition-missing-from-asset}
...
### AEM에서 자산 처리가 실패합니다{#asset-processing-fails}
