...
>title="개발 도구 설정"
>abstract="Adobe Experience Manager(AEM) 개발을 위해 최소한의 개발 도구 세트를 설치하고 개발자 시스템에 설정해야 합니다. 이러한 도구에는 Java, Maven, Adobe I/O CLI, 개발 IDE 등이 포함됩니다."
...
Adobe Experience Manager(AEM) 개발을 위해 최소한의 개발 도구 세트를 설치하고 개발자 시스템에 설정해야 합니다. 이러한 도구는 AEM 프로젝트의 개발 및 빌드를 지원합니다.
...
__[이클립스](https://www.eclipse.org/ide/)__ 는 Java 개발에 널리 사용되는 IDE이며  __[AEM 개발자 도구](https://experienceleague.adobe.com/docs/experience-manager-64/developing/devtools/aem-eclipse.html?lang=en)__ Adobe에서 제공하는 플러그인으로, 작성을 위한 in-IDE GUI를 제공하고 JCR 컨텐츠를 로컬 AEM 인스턴스와 동기화합니다.
