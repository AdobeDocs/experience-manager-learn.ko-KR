...
확대/축소 대상은 **편집** 메뉴 및 **세부 사항** 이미지의 페이지입니다. 이를 통해 &quot;핫스팟&quot;을 설정하여 확대/축소 이미지의 특정 머천다이징 기능을 강조 표시할 수 있습니다. 확대/축소 뷰어는 큰 마스터를 잘라서 별도의 이미지를 만드는 대신 사용자가 만드는 짧은 레이블과 함께 이미지 위에 세부 정보를 제공할 수 있습니다.
...
방법 알아보기 [확대/축소 대상 만들기](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/zoom/creating-zoom-targets-guided-zoom.html#creating-and-editing-zoom-targets).
...
1. 이미지를 찾은 다음 **편집** 단추 및 선택 **확대/축소 대상**.
...
7. 또한 대상을 제거해야 하는 경우 해당 축소판을 클릭하여 대상을 선택하고 **대상 삭제** 키보드에서 DELETE 키를 누르거나 누릅니다.
