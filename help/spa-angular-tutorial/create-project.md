...
6. `spa.project.core` 및 `core.wcm.components`에 대한 여러 패키지가 표시되어야 합니다. 이러한 종속성은 원형 유형에 의해 자동으로 포함되는 종속성입니다. [AEM 코어 구성 요소에 대한 자세한 내용은 여기](https://docs.adobe.com/content/help/ko-KR/experience-manager-core-components/using/introduction.html)에 있습니다.
