...
본 프로젝트에 대한 모든 제3자 기고물은 서명된 증여자 사용권 계약을 동반해야 합니다. 이를 통해 Adobe에 프로젝트의 일부로 기여도를 재배포할 수 있는 권한을 부여합니다. [CLA에 서명합니다](https://opensource.adobe.com/cla.html). 한 번만 Adobe CLA를 제출하면 되므로 이전에 제출한 CLA를 제출하면 됩니다.
